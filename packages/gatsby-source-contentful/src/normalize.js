...
exports.createNodesForContentType = ({
  ...
  locales.forEach(locale => {
    ...
    const entryNodes = entries.map(entryItem => {
      ...
      entryNode.internal.contentDigest = entryNode.updatedAt
    ...
    // The content of an entry is guaranteed to be updated if and only if the .sys.updatedAt field changed
    contentTypeNode.internal.contentDigest = contentTypeNode.updatedAt
...
exports.createAssetNodes = ({
  ...
  locales.forEach(locale => {
    ...
    // The content of an entry is guaranteed to be updated if and only if the .sys.updatedAt field changed
    assetNode.internal.contentDigest = assetNode.updatedAt
